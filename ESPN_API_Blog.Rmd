...
Its that time of year again.  The time when we dust off the old ESPN fantasy football API code and fix everything that's broken in the last year.  
...
To find your leagueID, look at the URL of your fantasy football home page.
...
I'm glad you asked.  In subsequent posts, I'll provide more examples, but here are a few quick examples.

### Extract one players information
...
```{r}
team_list <- purrr::map2_dfr(team_player_slots$team_number,team_player_slots$player_slot, ~player_extract(ESPNFromJSON = ESPNFromJSON,team_number = .x,player_number = .y, per_id = per_id)) 
...
Everything listed below is at my [github repo](https://github.com/dusty-turner/fantasyfootball2020).  

If you are the time/talent/background to help turn this into an R package, I'd love to learn from you and invite you to make some pull requests!

## Special Thanks

A special thanks to my friend and collaborator Jim Pleuss.  This code would not be what it is if not for him. 