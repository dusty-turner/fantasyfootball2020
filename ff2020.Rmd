...
```{r}
valueBox(value = str_c(unlist(mug$team), collapse = " & "), caption = str_c("Week ", per_id, " Mug (Best Team): ", mug$week_points[1], " Points"), icon = "fa-pencil")
```

### 

```{r}
valueBox(value = str_c(unlist(plunger$team), collapse = " & "), caption = str_c("Week ", per_id, " Plunger (Worst Team): ", plunger$week_points[1], " Points"), icon = "fa-pencil")
```
...
out <- lapply(seq_along(plots), function(i){
  ...
  a3 <- knitr::knit_expand(text = sprintf("\nplots[[%d]]$plot", i)) # extract graphs by "writing" out `hcs[[1]]`, `hcs[[2]]` etc. to be rendered later
